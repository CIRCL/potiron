...
# Describe fields
red.set("DS_sipcity", "sipcity is the city related to the source IP address that probed the sensor.")
red.set("DS_protocol", "protocol is the protocol field set in the IP packet.")
red.set("DS_iptos", "iptos is the type of service (TOS) field in the IP packet.")
red.set("DS_ipttl", "ipttl is the Time To Live (TTL) field in the IP packet.")
red.set("DS_ipsrc", "ipsrc is the source IP address that probed the sensor.")
red.set("DS_icmptype", "icmptype is the ICMP Type field set in the IP packet.")
red.set("DS_length", "length is the length of the IP packet.")
red.set("DS_dport", "dport is the destination port of an UDP or TCP packet.")
red.set("DS_sipcountry", "sipcounty is the country related to the source IP address that probed the sensor.")
red.set("DS_sport", "sport is the source port of the UDP or TCP packet.")
red.set("DS_icmpcode", "icmpcode is the ICMP code found in an ICMP packet.")
red.set("DS_ipop", "ipop are options of the IP packet.")
